<%@page import="com.jsp.intime.entity.MenProduct"%>
...
<body>
	...
	<section id="product1">
		...
		<%
			List<MenProduct> list = (List)request.getAttribute("menProducts");
			for(MenProduct mp : list)
			{
		%>
			<div class="pro">
				...
				<div id="des">
					...
					<h4>Rs<%=mp.getPrice()%>/-</h4>
					<form action="menadd"><input hidden="true" value=<%=mp.getId()%> name="path">
					<button>
